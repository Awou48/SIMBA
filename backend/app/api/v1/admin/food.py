...
# Explicit path: /api/v1/admin/foods/list
...
# Explicit path: /api/v1/admin/foods/add
...
# Explicit path: /api/v1/admin/foods/update/{id}
...
# Explicit path: /api/v1/admin/foods/delete/{id}
